...
| <a name="input_eks_nodepool_pattern"></a> [eks\_nodepool\_pattern](#input\_eks\_nodepool\_pattern) | Defines the prefix that scopes which node pools are allowed to be used by StreamNative. This should normally remain the default value. | `string` | `"*snc*"` | no |
